        ...
        return SliverAppBar(
          ...
          actions: [
            PopupMenuButton(
              ...
              return [
                PopupMenuItem(child: Text('Резюме', style: GoogleFonts.inter(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),)),
                PopupMenuItem(child: Text('Портфолио', style: GoogleFonts.inter(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),)),
              ];
            })
          ],
        );
