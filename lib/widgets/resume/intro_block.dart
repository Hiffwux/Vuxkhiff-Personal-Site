...
import "package:vuxkhiff/widgets/resume/vuxkille_mark_stack_block.dart";
      ...
      if (s_constrs.crossAxisExtent >= 1000) {
        return SliverToBoxAdapter(
          child: Container(
              ...
              child: Stack(
                children: [
                  const VuxkilleMarkStackBlock(date: '1107', year: '2024', time: '1440', numOfPage: '0001', color: Colors.white,),
                  ///Слой метка
